...
export const LeadMagnetModal: React.FC<LeadMagnetModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      logEvent(AnalyticsEvent.LEAD_CAPTURE, {
        source: 'free_guide_hero',
        email
      });
      ...
      try {
        const defaultUrl = `${window.location.origin}/downloads/AI-Strategy-for-Leaders.pdf`;
          ...
          html: `
            <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 12px;">
              ...
              <div style="margin: 30px 0;">
                <a href="${downloadUrl}" style="background-color: #1e3a8a; color: white; padding: 12px 24px; text-decoration: none; border-radius: 8px; font-weight: bold; display: inline-block;">Download the Playbook (PDF)</a>
              </div>
