    ...
    try {
      await sendEmail({
        ...
        html: `
          ...
          <p><strong>Organization:</strong> ${formState.organization}</p>
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600">info@mylearninglaunchpad.com</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center text-blue-900 shrink-0">
          ...
          <div className="bg-slate-50 p-8 md:p-10 rounded-3xl border border-slate-100 shadow-sm">
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button type="submit" className="w-full py-6 text-lg font-bold rounded-xl" disabled={isLoading}>
                  {isLoading ? <Loader2 className="w-6 h-6 animate-spin" /> : 'Send Message'}
                </Button>
              </form>
            )}
          </div>
